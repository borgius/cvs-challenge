locals {
  ...
  default_github_webhook_secret_ssm_parameter_name      = "${local.github_ssm_parameter_path_prefix}/webhook-secret"
  default_github_token_ssm_parameter_name               = "${local.github_ssm_parameter_path_prefix}/token"
  default_github_app_id_ssm_parameter_name              = "${local.github_ssm_parameter_path_prefix}/app-id"
  default_github_app_private_key_ssm_parameter_name     = "${local.github_ssm_parameter_path_prefix}/app-private-key"
  default_github_app_installation_id_ssm_parameter_name = "${local.github_ssm_parameter_path_prefix}/app-installation-id"
  github_webhook_secret_ssm_parameter_name = coalesce(
    var.github_webhook_secret_ssm_parameter_name,
    local.default_github_webhook_secret_ssm_parameter_name,
  )
  github_app_id_ssm_parameter_name = coalesce(
    var.github_app_id_ssm_parameter_name,
    local.default_github_app_id_ssm_parameter_name,
  )
  github_app_private_key_ssm_parameter_name = coalesce(
    var.github_app_private_key_ssm_parameter_name,
    local.default_github_app_private_key_ssm_parameter_name,
  )
...
module "service" {
  ...
  github_webhook_secret_ssm_parameter_name      = local.github_webhook_secret_ssm_parameter_name
  github_token_ssm_parameter_name               = var.github_token_ssm_parameter_name
  github_app_id_ssm_parameter_name              = local.github_app_id_ssm_parameter_name
  github_app_private_key_ssm_parameter_name     = local.github_app_private_key_ssm_parameter_name
  github_app_installation_id_ssm_parameter_name = var.github_app_installation_id_ssm_parameter_name
